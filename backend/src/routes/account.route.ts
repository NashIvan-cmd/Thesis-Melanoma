...
import { agreementToTerms, authenticateLogin, changePasswordController, checkAgreementController, createAccount, generateCode } from "../controllers/account.controller";
